...
// ANS: I had trouble with delete at first. I knew I couldn't just delete the value because the property
// would still be there. I wasn't sure which syntax to use for delete to work so I had to check the docs.
// I also struggled with adding an object to an object. Conceptually I understood it, but needed to figure
// out the syntax to get it to work.
// 
// How difficult was it to add and delete properties outside of the object itself?
// ANS: I thought it was pretty easy to add/delete. I could see it being difficult to remember which syntax works
// for each language, but I'm sure that will come with time.
// 
// What did you learn about manipulating objects in this challenge?
// ANS: I learned about nesting objects. It seems like it's pretty easy to do in JavaScript and I'm excited
// to see some more practical uses in future assignments.
//
//
//
//
